...
import { AddVehicleUpwordsJourneyStart } from "../../services/VehicleInfoApiService";
...
export default class VehicleUpWordJourneyStartAdd extends React.Component {
    ...
    Add = () => {
        ...
        AddVehicleUpwordsJourneyStart(data).then( (response) => {
        ...
        return (
            <>
                ...
                <View style={styles.container}>
                    <Header title={"Onward Journey Start"} />
                    <KeyboardAvoidingView
