...
import { AddVehicleDownwardsJourneyEnd } from "../../services/VehicleInfoApiService";
import OverlayLoader from "../../components/OverlayLoader";
import { Entypo } from '@expo/vector-icons'; 
import * as ImagePicker from 'expo-image-picker';
import AwesomeAlert from 'react-native-awesome-alerts';

export default class VehicleDownWordJourneyEndAdd extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    Add = () => {
        ...
        AddVehicleDownwardsJourneyEnd(data).then( (response) => {
        ...
        return (
            <>
                ...
                <View style={styles.container}>
                    <Header title={"Return Journey End"} />
                    <KeyboardAvoidingView
