...
export default class Proofs extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
					...
					<View style={styles.table}>
						<View style={styles.tableRow}>
							...
							<View style={styles.rowItem}>
								<Text style={{ fontWeight: 'bold' }}>Vol</Text>
							</View>
							<View style={styles.rowItem}>
								<Text style={{ fontWeight: 'bold' }}>Set Up</Text>
							</View>
						</View>
						{this.state.list.map(item => <View key={item.id}>
							<View style={styles.tableRow}>
								<View style={[styles.rowItem, { width: '60%', alignItems: 'flex-start' }]}>
