...
import { edit_game, CheckGamePriorityOrderForEdit } from "../../services/GameApiService";
...
export default class EditGame extends React.Component {
	constructor(props) {
		...
		this.state = {
			...
			imageURI: Configs.NEW_COLLECTION_URL + this.props.route.params.game.image,
			imageData: undefined,
			...
			gameTitle: this.props.route.params.game.name,
			price: this.props.route.params.game.rent,
			description: this.props.route.params.game.description,
			instruction: this.props.route.params.game.instruction,
			size: this.props.route.params.game.size,
            video_link: this.props.route.params.game.video_link,
			priority_id: this.props.route.params.game?.priority_id,
			priority_name: this.props.route.params.game?.priority_name,
			quantity: this.props.route.params.game?.quantity,
			number_of_staff:this.props.route.params.game?.number_of_staff,
			ordering:this.props.route.params.game?.ordering,
			isLoading: false,
			categories: [],
			subCategories: [],
	...
	editGame = () => {
		...
		CheckGamePriorityOrderForEdit(this.state.ordering, this.state.priority_id, this.state.id).then( (result) => {
			this.setState({
				isLoading: false
			});
	...
	render = () => {
		return (
			<View style={styles.container}>
				<Header title={"Edit "+this.state.gameTitle} />
